...
-- ============================================================
-- SESSÕES DE VOZ (atividade das salas)
-- Mostra quem está em cada canal de voz e há quanto tempo a
-- sala está ativa. (Para projetos já existentes, rode o
-- migration-voice-sessions.sql)
-- ============================================================
...
-- Estado do compartilhamento + sinalização WebRTC protegida por
-- RLS. Uma "chamada" é um canal de voz; participar exige ser
-- membro do servidor (mesma regra da voz). Vídeo/frames nunca
-- passam pelo banco — apenas metadados e sinais efêmeros.
-- (Para projetos já existentes, rode 20260823120000_screen_share.sql)
-- ============================================================
